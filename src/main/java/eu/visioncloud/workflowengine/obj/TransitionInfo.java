...
//	private ArrayList unrelated = new ArrayList();
	...
	public TransitionInfo(HandlerInfo f, HandlerInfo t, Map appearResult, Map disappearResult, Map constantResult){
		setFrom(f);
		setTo(t);
		setAcyclic(true);
	...
	private void CheckType(){
		if (triggerTypes[0] == 'n' && triggerTypes[1] == 'n' && triggerTypes[2] == 'n')
			finalType = "unrelated";
